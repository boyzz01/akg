...
class Admin extends Base {
	...
	public function notices(){
		...
		$_black_friday_notice_message = sprintf(
			...
			__( 'SAVE up to 80% & access to Templately Premium templates and features.', 'templately' ),
			esc_url('https://templately.com/#pricing'),
			__( 'Grab The Deal', 'templately' )
		);
        ...
        $notices->add(
            ...
            [
                ...
                'dismissible' => true,
                "expire"      => 1669852799,
                "display_if"  => empty( $global_user['plan'] ) || $global_user['plan'] == 'free'
            ]
        );
